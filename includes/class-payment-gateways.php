...
class Ultico_Gateway_BankWire extends Ultico_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->description = esc_html__( 'Pay via bank wire transfer. After placing your order, transfer the total amount to our bank account. Your order will be processed once payment is confirmed.', 'ulticommerce' );
    }
